        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid items-center gap-16 lg:grid-cols-2">
            ...
            <div>
              ...
              <div className="mt-8 space-y-4 text-base font-medium leading-relaxed text-secondary/70">
                <p>
      ...
      <section className="bg-background-subtle py-24 lg:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-8 text-base font-medium leading-relaxed text-secondary/70">
          ...
          <div className="mt-20 grid gap-8 md:grid-cols-3">
            {[
              ...
              <div
                key={value.title}
                className="rounded-xl bg-white p-8 shadow-[0_4px_20px_rgba(0,0,0,0.06)]"
              >
